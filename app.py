...
import streamlit as st
from Mypackage import dataset, helper, rankings
...
task = st.sidebar.selectbox("",("Current Rankings", 
                                "Win Prediction",
                                "Score Prediction",
                                "Analysis", 
                                "Project Members"))
...
if task == "Current Rankings":
    
    img = Image.open('static/sideimage.jpg')
    
    format = ["T20", "ODI", "Test"]
    option = st.sidebar.radio("Format", format)

    if option in ["T20", "ODI"]:
        radio = st.sidebar.radio("Gender", ["Men", "Women"])

    # T20i
    ## Batting
    ### Men
    if option == "T20" and radio == "Men":
        img = Image.open('static/t20mens.jfif')
        st.header("Mens T20i Team Ranking")
        ...
        st.header("Mens T20i Batter Ranking")
        
        url = "https://www.icc-cricket.com/rankings/mens/player-rankings/t20i/batting"
        bat = rankings.get_player_ranking(url)
        st.dataframe(bat)
        
        
        st.header("Mens T20i Bowler Ranking")
        
        url = "https://www.icc-cricket.com/rankings/mens/player-rankings/t20i/bowling"
        bowl = rankings.get_player_ranking(url)
        st.dataframe(bowl)
    
        
        st.header("Mens T20i All Rounder Ranking")
        url = "https://www.icc-cricket.com/rankings/mens/player-rankings/t20i/all-rounder"
        all_round = rankings.get_player_ranking(url)
        st.dataframe(all_round)
        
        
        
    
    ### Women 
    if option == "T20" and radio == "Women":
        img = Image.open('static/t20womens.jpg')
        st.header("Womens T20i Team Ranking")
        url = "https://www.icc-cricket.com/rankings/womens/team-rankings/t20i"
        rank = rankings.get_team_rankings(url)
        st.dataframe(rank)
        
        
        st.header("Womens T20i Ranking")
        url = "https://www.icc-cricket.com/rankings/womens/player-rankings/t20i/batting"
        bat = rankings.get_player_ranking(url)
        st.dataframe(bat)
        
        st.header("Womens T20i Bowler Ranking")
        ...
        st.header("Womens T20i All Rounder Ranking")
    ...
    ## Batting
    ### Men
    if option == "ODI" and radio == "Men":
        img = Image.open('static/odimens.jfif')
        st.header("Mens ODI Team Ranking")
        url = "https://www.icc-cricket.com/rankings/mens/team-rankings/odi"
        rank = rankings.get_team_rankings(url)
        st.dataframe(rank)
        
        
        st.header("Mens ODI Ranking")
        
        url = "https://www.icc-cricket.com/rankings/mens/player-rankings/odi/batting"
        bat = rankings.get_player_ranking(url)
        st.dataframe(bat)
        
        st.header("Mens ODI Bowler Ranking")
        ...
        st.header("Mens ODI All Rounder Ranking")
    ...
    ### Women  
    if option == "ODI" and radio == "Women":
        img = Image.open('static/odiwomens.jpg')
        st.header("Womens ODI Team Ranking")
        url = "https://www.icc-cricket.com/rankings/womens/team-rankings/odi"
        rank = rankings.get_team_rankings(url)
        st.dataframe(rank)
        
        
        st.header("Womens ODI Ranking")
        url = "https://www.icc-cricket.com/rankings/womens/player-rankings/odi/batting"
        bat = rankings.get_player_ranking(url)
        st.dataframe(bat)
        
        
        st.header("Womens ODI Bowler Ranking")
        ...
        st.header("Women ODI All Rounder Ranking")
    ...
    ## Batting  
    if option == "Test":
        img = Image.open('static/testmen.jpg')
        st.header("Mens Test Team Ranking")
        url = "https://www.icc-cricket.com/rankings/mens/team-rankings/test"
        rank = rankings.get_team_rankings(url)
        st.dataframe(rank)
        
        
        st.header("Mens Test Player Batter Ranking")
        ...
        st.header("Mens Test Player Bowler Ranking")
        ...
        st.header("Mens Test Player All-Rounder Ranking")
...
if task=="Win Prediction":
    img = Image.open('static/ipll.jpeg')
    st.sidebar.image(img)
...
if task=="Score Prediction":
    img = Image.open('static/worldcup.jpg')
    st.sidebar.image(img)
...
if task=="Project Members":
    names = '''<p>
    <ul>
    <li><span style="color: blue; font-weight: bold; font-size:35px;">Aditya Naranje</span></li>
    <li><span style="color: blue; font-weight: bold; font-size:35px;">Shravan Kale</span></li>
    <li><span style="color: blue; font-weight: bold; font-size:35px;">Yogeshwar Ghode</span></li>
    <li><span style="color: blue; font-weight: bold; font-size:35px;">Sarthak Shirbhate</span></li>
    </ul>
    </p>
    '''
